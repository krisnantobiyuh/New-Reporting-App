...
$app->group('', function() use ($app, $container) {
    ...
    // route pic
    $app->get('/pic/items/group/{id}', 'App\Controllers\web\PicController:getUnreportedItem')->setName('pic.item.group');
    $app->get('/pic/items/group/{id}/reported', 'App\Controllers\web\PicController:getReportedItem')->setName('web.pic.group.reported');
    $app->get('/pic/items/delete/{id}', 'App\Controllers\web\PicController:deleteTugas')->setName('web.pic.delete.tugas');
    $app->get('/pic/search/user', 'App\Controllers\web\UserController:searchUser')->setName('web.pic.search.user');
    $app->get('/pic/group/{id}/member', 'App\Controllers\web\PicController:getMemberGroup')->setName('pic.group.member');
    $app->post('/pic/set/member', 'App\Controllers\web\GroupController:setMemberGroup')->setName('web.pic.set.member');
    $app->post('/pic/delete/member', 'App\Controllers\web\GroupController:deleteUser')->setName('web.pic.delete.member');
    $app->post('/pic/set/status', 'App\Controllers\web\GroupController:setAsPicGroup')->setName('web.pic.set.status');
    $app->post('/pic/create/item', 'App\Controllers\web\PicController:createItem')->setName('web.pic.create.item');
    $app->get('/pic/show/item/{id}', 'App\Controllers\web\PicController:showItem')->setName('web.pic.show   .item');
